/* zzdhfa.f -- translated by f2c (version 19980913).
...
/* $Procedure ZZDHFA ( Time derivative of half angle ) */
doublereal zzdhfa_(doublereal *state, doublereal *bodyr)
{
...
/*     describes the half angle of a spherical body (ALPHA), i.e. the */
...
/*     Take the derivative of ALPHA with repect to time */
...
/*     C     separation between the earth aand Moon as seen from the sun. */
/*     C */
